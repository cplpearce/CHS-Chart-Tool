...
def whatstheplan():                                                                                             # XXXXX  PROMPUT USER INPUT  XXXXX
    ...
    print('')                                                                                                   # blank space
    time.sleep(.2)                                                                                              # sleep to wow the user                                                                                              # sleepy sleepy
    print('')                                                                                                   # blank space 
    time.sleep(.2)                                                                                              # sleep to wow the user                                                                                              # sleepy sleepy
    print('')                                                                                                   # blank space
    time.sleep(.2)                                                                                              # sleep to wow the user                                                                                              # sleepy sleepy
...
def processMetadata():                                                                                          # XXXXX  GET CHART METADATA  XXXXX
    ...
    countVars = {                                                                                               # decalre the counts in a mutable dict, as global/local vars are shit on pyhton 2.7
